...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " جوكر"
SudosS = {6941561387}
Sudos = {sudoid,6941561387}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
{{text = ' 🇮🇶 ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "جوكر"),data="delnamebot"}},
...
os.execute('wget https://raw.githubusercontent.com/zxyu101/n/Files/start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://raw.githubusercontent.com/zxyu101/n/main/Files/start.lua -o start.lua')
dofile('start.lua')  
end
end
if text == "تحديث" then
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "جوكر"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "جوكر"),"اني لقميل "..(redis:get(bot_id..":namebot") or "جوكر"),(redis:get(bot_id..":namebot") or "جوكر").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "جوكر") then
